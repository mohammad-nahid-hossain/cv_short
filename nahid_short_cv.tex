...
\namesection{Mohammad Nahid}{Hossain}{{Bounia, Vadalodi, Uttara, Dhaka-1229}\\
	%{Permanent Add: Vill: Shitarampur, Post: Shitarampur (8131), Upazilla: Kashiani, Dist: Gopalganj} \\
\href{mailto:nahid.ebrahim18@gmail.com}{nahid.ebrahim18@gmail.com} | +8801689905382\\
 \urlstyle{same}\url{http://mohammad-nahid-hossain.github.io/}
...
\runsubsection{Lecturer}
\descript{| Institute of Science Trade \& Technology (ISTT) }
\location{January 2018 - Present | Mirpur, Dhaka}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\runsubsection{Route Tracker using GPS Technology}\\
...
\sectionsep
\runsubsection{Tic-tac-toe game solutions (Supervised Learning)}\\
...
\sectionsep
\runsubsection{Cereal Dataset (Unsupervised Learning)}\\
...
\location{April 2017 | Dhaka, Bangladesh \\ CGPA: 3.78 \\ Thesis:  A Routing Protocol with Energy Harvesting Model for Wireless Nano Sensors in Cancer Cell Detection}
\sectionsep	
