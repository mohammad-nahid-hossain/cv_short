...
\namesection{Mohammad Nahid}{Hossain}{{144, East Kazipara, Kafrul, Dhaka-1216, Bangladesh}\\
...
Android Studio \textbullet{} Hadoop \textbullet{} Weka\\ Matlab \textbullet{} Unity 3D \\
...
\descript{B.Sc (Engg.) in Computer Science \& Engineering}
\location{January 2017 | Dhaka, Bangladesh \\ CGPA: 3.80 \\ Thesis: Study on Bangla Machine Translation Technique using Long Short Term Memory (LSTM)}
\sectionsep	
